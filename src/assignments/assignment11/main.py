...
invoice2 = Invoice(AverageCustomer('Customer', 'Jones', '5127894562'), '03232018')
invoice3 = Invoice(GoodCustomer('Customer', 'Stutz', '5127845000'), '04142018')
...
while keep_going == 'y':
    ...
    invoice2.add_invoice_item(InvoiceItem(Product(2, description, cost), quantity))
    #ASSIGNMENT 11: add an invoice item to invoice 3 object with exact same Invoice item as invoice3 above
    invoice3.add_invoice_item(InvoiceItem(Product(3, description, cost), quantity))
